...
def compute_feature_importance(data, date_ranges,
    ...
    for target in target_columns:
        ...
        # === Save the model, imputer, scaler, and feature list ===
        model_bundle = {
            'model': best_rf,
            'imputer': imputer,
            'scaler': scaler,
        ...
        joblib.dump(model_bundle, f"RF_model_{target}_val_{pred_station}.joblib")
        ...
        if pred_station and pred_station.lower() != "none" and not val.empty:
            ...
            print("Skipping validation phase because station='none' or validation data is empty.")
